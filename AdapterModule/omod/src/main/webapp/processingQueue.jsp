...
<div id="processingTransactions" style="text-align: center;">
	...
	<c:if test="${fn:length(processingTransactions) > 10}">
			...
			<tbody>
				...
				<c:forEach var="processingTransactions"
					...
					<tr class="${num.count%2!=0?'evenRow':'oddRow'}">
						...
						<td><textarea rows="10" cols="50" style="border:none;" class="" readonly="readonly">${processingTransactions.message}</textarea></td>
						<td>${processingTransactions.url}</td>
