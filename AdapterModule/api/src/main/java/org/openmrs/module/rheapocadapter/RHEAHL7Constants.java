...
public class RHEAHL7Constants {
	...
	public static final String TRIGGER_EVENT = "R01";

	public static final String MESSAGE_STRUCTURE = "ORU_R01";
	...
	public static final String SENDING_FACILITY = "357";

	public static final String RECEIVING_FACILITY = "Shared Health Record";
	...
	public static final String PROVIDER_IDENTIFIER = "NID number";

	// PID

	public static final String IDENTIFIER_TYPE = "NID";
	...
	public static final String MUTUELLE_ID_TYPE = "MUT";
	
	public static final String NID_ID_TYPE = "NID";
	
	public static final String RAMA_ID_TYPE = "RAM";
	
	public static final String OMRS_ID_TYPE_PREFIX = "OMRS";

	// OBX

	public static final String RW_CS = "LN";
	...
	// Copied from HL7Constants 1.8.3
